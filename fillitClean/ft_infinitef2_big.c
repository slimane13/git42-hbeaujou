...
void	ft_boucle_f6_big(int flag[26], int g_nbr_crt[26])
{
	...
	{
		calc(backtrack, g_nbr_crt, i6, &g_test_larg6, &g_test_haut6, 6);
		if (g_test_larg6 < g_test_max + 1)
		{
			g_tampon = resitue(g_tmp_calc, (4 * g_nbr_crt[5]), g_taille_max);
...
void	ft_boucle_f7_big(int flag[26], int g_nbr_crt[26])
{
	...
	{
		calc(backtrack, g_nbr_crt, i7, &g_test_larg7, &g_test_haut7, 7);
		if (g_test_larg7 < g_test_max + 1)
		{
			g_tampon = resitue(g_tmp_calc, (4 * g_nbr_crt[6]), g_taille_max);
...
void	ft_boucle_f8_big(int flag[26], int g_nbr_crt[26])
{
	...
	{
		calc(backtrack, g_nbr_crt, i8, &g_test_larg8, &g_test_haut8, 8);
		if (g_test_larg8 < g_test_max + 1)
		{
			g_tampon = resitue(g_tmp_calc, (4 * g_nbr_crt[7]), g_taille_max);
...
void	ft_boucle_f9_big(int flag[26], int g_nbr_crt[26])
{
	...
	{
		calc(backtrack, g_nbr_crt, i9, &g_test_larg9, &g_test_haut9, 9);
		if (g_test_larg9 < g_test_max + 1)
		{
			g_tampon = resitue(g_tmp_calc, (4 * g_nbr_crt[8]), g_taille_max);
...
void	ft_boucle_f10_big(int flag[26], int g_nbr_crt[26])
{
	...
	{
		calc(backtrack, g_nbr_crt, i10, &g_test_larg10, &g_test_haut10, 10);
		if (g_test_larg10 < g_test_max + 1)
		{
			g_tampon = resitue(g_tmp_calc, (4 * g_nbr_crt[9]), g_taille_max);
