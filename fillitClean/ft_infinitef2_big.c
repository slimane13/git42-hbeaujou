...
void	ft_boucle_f6_big(int flag[26], int nbr_courant[26])
{
	...
	{
		calc(backtrack, nbr_courant, i6, &test_larg6, &test_haut6, 6);
...
void	ft_boucle_f7_big(int flag[26], int nbr_courant[26])
{
	...
	{
		calc(backtrack, nbr_courant, i7, &test_larg7, &test_haut7, 7);
...
void	ft_boucle_f8_big(int flag[26], int nbr_courant[26])
{
	...
	{
		calc(backtrack, nbr_courant, i8, &test_larg8, &test_haut8, 8);
...
void	ft_boucle_f9_big(int flag[26], int nbr_courant[26])
{
	...
	{
		calc(backtrack, nbr_courant, i9, &test_larg9, &test_haut9, 9);
...
void	ft_boucle_f10_big(int flag[26], int nbr_courant[26])
{
	...
	{
		calc(backtrack, nbr_courant, i10, &test_larg10, &test_haut10, 10);
