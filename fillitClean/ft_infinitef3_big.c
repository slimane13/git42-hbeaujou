...
/*   Updated: 2015/12/08 18:13:19 by hbeaujou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_boucle_f11_big(int flag[26], int nbr_courant[26])
{
	...
	{
		calc_attrib(clean11, nbr_courant, i11, &test_larg11, &test_haut11, 11);
...
void	ft_boucle_f12_big(int flag[26], int nbr_courant[26])
{
	...
	{
		calc_attrib(clean12, nbr_courant, i12, &test_larg12, &test_haut12, 12);
...
void	ft_boucle_f13_big(int flag[26], int nbr_courant[26])
{
	...
	{
		calc_attrib(clean13, nbr_courant, i13, &test_larg13, &test_haut13, 13);
...
void	ft_boucle_f14_big(int flag[26], int nbr_courant[26])
{
	...
	{
		calc_attrib(clean14, nbr_courant, i14, &test_larg14, &test_haut14, 14);
...
void	ft_boucle_f15_big(int flag[26], int nbr_courant[26])
{
	...
	while (i15 < iter_max)
	{
		calc_attrib(clean15, nbr_courant, i15, &test_larg15, &test_haut15, 15);
