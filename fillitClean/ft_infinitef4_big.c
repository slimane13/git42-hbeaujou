...
/*   Updated: 2015/12/08 18:13:24 by hbeaujou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_boucle_f16_big(int flag[26], int nbr_courant[26])
{
	...
	{
		calc_attrib(clean16, nbr_courant, i16, &test_larg16, &test_haut16, 16);
...
void	ft_boucle_f17_big(int flag[26], int nbr_courant[26])
{
	...
	{
		calc_attrib(clean17, nbr_courant, i17, &test_larg17, &test_haut17, 17);
...
void	ft_boucle_f18_big(int flag[26], int nbr_courant[26])
{
	...
	{
		calc_attrib(clean18, nbr_courant, i18, &test_larg18, &test_haut18, 18);
...
void	ft_boucle_f19_big(int flag[26], int nbr_courant[26])
{
	...
	{
		calc_attrib(clean19, nbr_courant, i19, &test_larg19, &test_haut19, 19);
...
void	ft_boucle_f20_big(int flag[26], int nbr_courant[26])
{
	...
	while (i20 < iter_max)
	{
		calc_attrib(clean20, nbr_courant, i20, &test_larg20, &test_haut20, 20);
