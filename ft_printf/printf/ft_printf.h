...
/*   Updated: 2015/12/30 17:09:07 by hbeaujou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_cut_init_u_z(t_cut *t_v, t_var **var, char **str, int count[3]);
void    ft_cut_flag_u1_z(t_cut *t_v, char **str, int count[3]);
void    ft_cut_flag_u2_z(t_cut *t_v, t_var **var, char **str, int count[3]);
...
void	ft_cut_init_x_mchr(t_cut *t_v, t_var **var, char **str, int count[3]);
void    ft_cut_flag_x1_mchr(t_cut *t_v, t_var **var, char **str, int count[3]);
void    ft_cut_flag_x2_mchr(t_cut *t_v, char **str, int count[3]);
void    ft_cut_flag_x2_1mchr(t_cut *t_v, char **str, int count[3]);
void    ft_cut_flag_x2_2mchr(t_cut *t_v, char **str, int count[3]);
...
void	ft_cut_init_o_char(t_cut *t_v, t_var **var, char **str, int count[3]);
void    ft_cut_flag_o1_char(t_cut *t_v, t_var **var, char **str, int count[3]);
void    ft_cut_flag_o2_char(t_cut *t_v, char **str, int count[3]);
void    ft_cut_flag_o2_1char(t_cut *t_v, char **str, int count[3]);
void    ft_cut_flag_o2_2char(t_cut *t_v, char **str, int count[3]);
...
void    ft_cut_flag_o2_short(t_cut *t_v, char **str, int count[3]);
void    ft_cut_flag_o2_1short(t_cut *t_v, char **str, int count[3]);
void    ft_cut_flag_o2_2short(t_cut *t_v, char **str, int count[3]);
